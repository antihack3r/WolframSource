...
extends BlockContainer {
    ...
    private void dropRecord(World worldIn, BlockPos pos, IBlockState state) {
        ...
        if (!worldIn.isRemote && (tileentity = worldIn.getTileEntity(pos)) instanceof TileEntityJukebox && !(itemstack = (blockjukebox$tileentityjukebox = (TileEntityJukebox)tileentity).getRecord()).func_190926_b()) {
    ...
    public int getComparatorInputOverride(IBlockState blockState, World worldIn, BlockPos pos) {
        ItemStack itemstack;
        TileEntity tileentity = worldIn.getTileEntity(pos);
        if (tileentity instanceof TileEntityJukebox && !(itemstack = ((TileEntityJukebox)tileentity).getRecord()).func_190926_b()) {
