...
implements IProgressUpdate {
    ...
    private static final ResourceLocation bg = new ResourceLocation("wolfram/bg-blur.jpg");
    ...
    public void setLoadingProgress(int progress) {
        if (!this.mc.running) {
            ...
            if (i - this.systemTime >= 100L) {
                ...
                Gui.drawScaledCustomSizeModalRect(0, 0, 0.0f, 0.0f, 3840, 2160, RenderUtils.getDisplayWidth(), RenderUtils.getDisplayHeight(), 3840.0f, 2160.0f);
                if (progress >= 0) {
                    int i1 = 100;
                    int j1 = 2;
                    int k1 = k / 2 - 50;
