...
extends AbstractClientPlayer {
    ...
    private void onUpdateWalkingPlayer() {
        boolean flag1;
        Dispatcher.call(new PreMotionUpdateEvent());
        ...
        Dispatcher.call(new PostMotionUpdateEvent());
    }
    ...
    public boolean isSneaking() {
        boolean flag;
        boolean bl = flag = this.movementInput != null && this.movementInput.sneak;
    ...
    public void onLivingUpdate() {
        ...
        if (this.isHandActive() && !this.isRiding() && !Wolfram.getWolfram().moduleManager.isEnabled("noslowdown")) {
        ...
        if (this.isSprinting() && (this.movementInput.moveForward < 0.8f || this.isCollidedHorizontally || !flag4) && !Wolfram.getWolfram().moduleManager.isEnabled("sprint")) {
            this.setSprinting(false);
        }
        if (this.capabilities.allowFlying || Wolfram.getWolfram().moduleManager.isEnabled("creativefly")) {
    ...
    public void moveEntity(MoverType moverType, double x, double y, double z) {
        ...
        double d0 = this.posX;
        double d1 = this.posZ;
        super.moveEntity(moverType, event.getMotionX(), event.getMotionY(), event.getMotionZ());
