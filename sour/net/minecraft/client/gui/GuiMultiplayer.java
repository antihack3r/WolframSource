...
import net.wolframclient.compatibility.Gui1121Mode;
...
extends GuiScreen {
    ...
    public void createButtons() {
        ...
        this.buttonList.add(new GuiButton(-99, this.width / 2 - 154, 10, 100, 20, "Alt Accounts"));
        this.buttonList.add(new GuiButton(-100, this.width / 2 + 54, 10, 100, 20, "Version: " + new Version("1.12." + Wolfram.getWolfram().getClientSettings().getInt("mc112x_compatibility"))));
    ...
    protected void actionPerformed(GuiButton button) throws IOException {
        if (button.enabled) {
            ...
            if (button.id == 2 && guilistextended$iguilistentry instanceof ServerListEntryNormal) {
                ...
                this.mc.displayGuiScreen(new Gui1121Mode(this));
            }
        }
    }
