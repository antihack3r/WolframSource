...
import net.wolframclient.gui.screen.wolfram.WolframMenuScreen;
...
extends GuiScreen {
    ...
    public void initGui() {
        ...
        int i = 0;
        GameSettings.Options[] optionsArray = SCREEN_OPTIONS;
        int n = SCREEN_OPTIONS.length;
        int n2 = 0;
        while (n2 < n) {
        ...
        if (this.mc.world != null) {
            ...
            if (this.mc.isSingleplayer() && !this.mc.world.getWorldInfo().isHardcoreModeEnabled()) {
                this.difficultyButton.setWidth(this.difficultyButton.getButtonWidth() - 45);
        ...
        this.buttonList.add(new GuiButton(-100, this.width / 2 - 155, this.height / 6 + 22 - 6, 310, 20, "Wolfram Menu"));
    ...
    protected void actionPerformed(GuiButton button) throws IOException {
        if (button.enabled) {
            if (button.id == -100) {
                this.mc.displayGuiScreen(new WolframMenuScreen(this));
                return;
            }
