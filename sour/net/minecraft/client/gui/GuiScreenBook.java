...
extends GuiScreen {
    ...
    private GuiTextField bookHackCommand;
    private GuiButton bookHackButton;
    private boolean bookHack = false;
    ...
    public void initGui() {
        ...
        this.bookHackCommand = new GuiTextField(-1, FontRenderers.getFontRenderer(), this.width / 2 - 100, 221, 150, 20);
        this.bookHackCommand.setMaxStringLength(150);
        this.bookHackCommand.setFocused(false);
        this.bookHackButton = new GuiButton(-2, this.width / 2 + 50, 221, 50, 20, "Book Hack");
        this.buttonList.add(this.bookHackButton);
        ...
        this.updateButtons();
        this.fontRendererObj = FontRenderers.MINECRAFT;
    }
    ...
    private void updateButtons() {
        ...
        this.bookHackButton.visible = this.bookGettingSigned && this.bookIsUnsigned;
        this.bookHackCommand.setVisible(this.bookGettingSigned && this.bookIsUnsigned);
        if (this.bookIsUnsigned) {
    ...
    private void sendBookToServer(boolean publish) throws IOException {
        if (this.bookIsUnsigned && this.bookIsModified && this.bookPages != null) {
            ...
            if (publish) {
                ...
                int var3 = 0;
                while (var3 < this.bookPages.tagCount()) {
                    String var4 = this.bookPages.getStringTagAt(var3);
                    TextComponentString var5 = new TextComponentString(var4);
                    if (this.bookHack) {
                        var5.getStyle().setClickEvent(new ClickEvent(ClickEvent.Action.RUN_COMMAND, this.bookHackCommand.getText()));
                    }
                    var4 = ITextComponent.Serializer.componentToJson(var5);
    ...
    protected void actionPerformed(GuiButton button) throws IOException {
        if (button.enabled) {
            ...
            } else if (button.id == -2 && this.bookGettingSigned) {
                this.bookHack = true;
                this.sendBookToServer(true);
                this.mc.displayGuiScreen(null);
            }
    ...
    protected void keyTyped(char typedChar, int keyCode) throws IOException {
        ...
        if (this.bookIsUnsigned && this.bookHackCommand.isFocused()) {
            this.bookHackCommand.textboxKeyTyped(typedChar, keyCode);
            return;
        }
        if (this.bookIsUnsigned) {
    ...
    private void pageInsertIntoCurrent(String p_146459_1_) {
        ...
        int i = this.fontRendererObj.splitStringWidth(String.valueOf(s1) + (Object)((Object)TextFormatting.BLACK) + "_", 118);
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks) {
        ...
        if (this.bookGettingSigned) {
            ...
            if (this.bookIsUnsigned && !this.bookHackCommand.isFocused()) {
                s = this.updateCount / 6 % 2 == 0 ? String.valueOf(s) + (Object)((Object)TextFormatting.BLACK) + "_" : String.valueOf(s) + (Object)((Object)TextFormatting.GRAY) + "_";
            }
            ...
            this.fontRendererObj.drawString((Object)((Object)TextFormatting.DARK_GRAY) + s2, i + 36 + (116 - i1) / 2, 60, 0);
            ...
            if (this.bookIsUnsigned) {
                s5 = this.fontRendererObj.getBidiFlag() ? String.valueOf(s5) + "_" : (this.updateCount / 6 % 2 == 0 ? String.valueOf(s5) + (Object)((Object)TextFormatting.BLACK) + "_" : String.valueOf(s5) + (Object)((Object)TextFormatting.GRAY) + "_");
        ...
        if (this.bookIsUnsigned) {
            this.bookHackCommand.drawTextBox();
        }
    ...
    protected void mouseClicked(int mouseX, int mouseY, int mouseButton) throws IOException {
        ...
        this.bookHackCommand.mouseClicked(mouseX, mouseY, mouseButton);
    }
