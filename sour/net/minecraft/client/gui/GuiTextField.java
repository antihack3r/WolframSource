...
extends Gui {
    ...
    private AnimationTimer anim = new AnimationTimer(20);
    ...
    public void drawTextBox() {
        if (this.getVisible()) {
            if (this.getEnableBackgroundDrawing()) {
                this.anim.update(this.isFocused);
                int alpha = (int)(this.anim.getValue() * 96.0);
                RenderUtils.drawRect(this.xPosition, this.yPosition, this.width, this.height, -1874306718 + 0x1000000 * alpha);
            }
            ...
            if (!s.isEmpty()) {
                ...
                this.fontRendererInstance.drawString(this.label, l, i1, wolfram.guiManager.getHexMainColor());
            }
