...
public class GuiUtilRenderComponents {
    ...
    public static List<ITextComponent> splitText(ITextComponent textComponent, int maxTextLenght, FontRenderer fontRendererIn, boolean p_178908_3_, boolean forceTextColor) {
        ...
        while (j < list1.size()) {
            ...
            DisplayComponentEvent event = new DisplayComponentEvent(itextcomponent1);
            Dispatcher.call(event);
            itextcomponent1 = event.getComponent();
            ...
            String s5 = (s4 = GuiUtilRenderComponents.removeTextColorsIfConfigured(String.valueOf(itextcomponent1.getStyle().getFormattingCode()) + s, forceTextColor)).endsWith("\n") ? s4.substring(0, s4.length() - 1) : s4;
