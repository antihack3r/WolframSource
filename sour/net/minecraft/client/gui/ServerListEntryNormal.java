...
implements GuiListExtended.IGuiListEntry {
    ...
    public void func_192634_a(int p_192634_1_, int p_192634_2_, int p_192634_3_, int p_192634_4_, int p_192634_5_, int p_192634_6_, int p_192634_7_, boolean p_192634_8_, float p_192634_9_) {
        ...
        switch (Wolfram.getWolfram().getClientSettings().getInt("mc112x_compatibility")) {
            case 2: {
                flag2 = this.server.version != 340;
                break;
            }
            case 1: {
                flag2 = this.server.version != 338;
                break;
            }
            default: {
                flag2 = !WMinecraft.PROTOCOLS.containsKey(this.server.version);
            }
        }
