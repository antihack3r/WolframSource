...
implements IProgressMeter {
    ...
    extends GuiSlot {
        ...
        protected void renderMouseHoverToolTip(StatCrafting p_148213_1_, int p_148213_2_, int p_148213_3_) {
            ...
            String s;
            String s1;
            if (p_148213_1_ != null && !(s1 = I18n.format(String.valueOf(s = (itemstack = new ItemStack(item = p_148213_1_.getItem())).getUnlocalizedName()) + ".name", new Object[0]).trim()).isEmpty()) {
