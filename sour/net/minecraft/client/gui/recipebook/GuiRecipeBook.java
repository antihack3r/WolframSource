...
extends Gui
implements IRecipeUpdateListener {
    ...
    public void func_193014_a(boolean p_193014_1_, InventoryCrafting p_193014_2_) {
        ...
        this.field_193962_q.setTextColor(0xFFFFFF);
    ...
    private void func_193003_g(boolean p_193003_1_) {
        ...
        if (!s.isEmpty()) {
            ObjectLinkedOpenHashSet objectset = new ObjectLinkedOpenHashSet(this.field_191888_F.func_193987_a(SearchTreeManager.field_194012_b).func_194038_a(s.toLowerCase(Locale.ROOT)));
            list1.removeIf(arg_0 -> GuiRecipeBook.lambda$3((ObjectSet)objectset, arg_0));
        }
    ...
    private void func_193949_f() {
        ...
        for (GuiButtonRecipeTab guibuttonrecipetab : this.field_193018_j) {
            ...
            if (!guibuttonrecipetab.func_193919_e()) continue;
            guibuttonrecipetab.func_191752_c(i, j + 27 * l++);
    ...
    public void func_191876_c(int p_191876_1_, int p_191876_2_, int p_191876_3_, int p_191876_4_) {
        if (this.func_191878_b()) {
            ...
            if (this.field_193960_m.isMouseOver()) {
                String s1 = I18n.format(this.field_193960_m.func_191754_c() ? "gui.recipebook.toggleRecipes.craftable" : "gui.recipebook.toggleRecipes.all", new Object[0]);
    ...
    private void func_193015_d(int p_193015_1_, int p_193015_2_, int p_193015_3_, int p_193015_4_) {
        ...
        int i = 0;
        while (i < this.field_191915_z.func_192684_b()) {
    ...
    public boolean func_191862_a(int p_191862_1_, int p_191862_2_, int p_191862_3_) {
        if (this.func_191878_b() && !this.field_191888_F.player.isSpectator()) {
            ...
            for (GuiButtonRecipeTab guibuttonrecipetab : this.field_193018_j) {
                if (!guibuttonrecipetab.mousePressed(this.field_191888_F, p_191862_1_, p_191862_2_)) continue;
    ...
    public boolean func_193955_c(int p_193955_1_, int p_193955_2_, int p_193955_3_, int p_193955_4_, int p_193955_5_, int p_193955_6_) {
        ...
        boolean bl = flag1 = p_193955_3_ - 147 < p_193955_1_ && p_193955_1_ < p_193955_3_ && p_193955_4_ < p_193955_2_ && p_193955_2_ < p_193955_4_ + p_193955_6_;
    ...
    private void func_193950_a(IRecipe p_193950_1_, List<Slot> p_193950_2_, int p_193950_3_, InventoryCraftResult p_193950_4_) {
        ...
        if (flag) {
            boolean flag1 = true;
            int j = 0;
            while (j < this.field_193961_o.getSizeInventory()) {
        ...
        if (this.field_193965_u.func_194118_a(p_193950_1_, (IntList)(intlist = new IntArrayList()), i1 = this.func_193943_a(i, flag))) {
            int j1 = i1;
            IntListIterator lvt_10_1_ = intlist.iterator();
            while (lvt_10_1_.hasNext()) {
                int k = (Integer)lvt_10_1_.next();
                int l = RecipeItemHelper.func_194115_b(k).getMaxStackSize();
                if (l >= j1) continue;
                j1 = l;
            }
            if (this.field_193965_u.func_194118_a(p_193950_1_, (IntList)intlist, j1)) {
                List<CPacketRecipePlacement.ItemMove> list2 = this.func_193954_a(p_193950_4_);
                ArrayList list3 = Lists.newArrayList();
                this.func_193013_a(p_193950_1_, p_193950_2_, j1, (IntList)intlist, list3);
    ...
    private List<CPacketRecipePlacement.ItemMove> func_193954_a(InventoryCraftResult p_193954_1_) {
        ...
        int i = 0;
        while (i < this.field_193961_o.getSizeInventory()) {
    ...
    private void func_193013_a(IRecipe p_193013_1_, List<Slot> p_193013_2_, int p_193013_3_, IntList p_193013_4_, List<CPacketRecipePlacement.ItemMove> p_193013_5_) {
        ...
        int j1 = 1;
        IntListIterator iterator = p_193013_4_.iterator();
        int k = 0;
        while (k < this.field_193961_o.getWidth() && j != k) {
            int l = 0;
            while (l < this.field_193961_o.getHeight()) {
    ...
    private void func_193951_a(IRecipe p_193951_1_, List<Slot> p_193951_2_) {
        ...
        this.field_191915_z.func_194187_a(Ingredient.func_193369_a(itemstack), p_193951_2_.get((int)0).xDisplayPosition, p_193951_2_.get((int)0).yDisplayPosition);
        int i = this.field_193961_o.getWidth();
        int j = this.field_193961_o.getHeight();
    ...
    private static /* synthetic */ boolean lambda$3(ObjectSet objectSet, RecipeList p_193947_1_) {
