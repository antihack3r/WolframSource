...
public class PlayerControllerMP {
    ...
    public boolean onPlayerDestroyBlock(BlockPos pos) {
        ...
        if (!this.currentGameType.isCreative() && !(itemstack1 = this.mc.player.getHeldItemMainhand()).func_190926_b()) {
    ...
    public boolean clickBlock(BlockPos loc, EnumFacing face) {
        ...
        if (this.currentGameType.isCreative()) {
            ...
            blockHitDelay = 5;
        } else if (!isHittingBlock || !this.isHittingPosition(loc)) {
            boolean flag;
            if (isHittingBlock) {
    ...
    public boolean onPlayerDamageBlock(BlockPos posBlock, EnumFacing directionFacing) {
        PlayerDamageBlockEvent event = new PlayerDamageBlockEvent(posBlock, directionFacing, this.curBlockDamageMP);
        Dispatcher.call(event);
        this.curBlockDamageMP = event.getProgress();
    ...
    private boolean isHittingPosition(BlockPos pos) {
        ...
        if (!this.currentItemHittingBlock.func_190926_b() && !itemstack.func_190926_b()) {
            boolean bl2 = flag = itemstack.getItem() == this.currentItemHittingBlock.getItem() && ItemStack.areItemStackTagsEqual(itemstack, this.currentItemHittingBlock) && (itemstack.isItemStackDamageable() || itemstack.getMetadata() == this.currentItemHittingBlock.getMetadata());
        }
    ...
    public boolean extendedReach() {
        return this.currentGameType.isCreative() || Wolfram.getWolfram().moduleManager.isEnabled("reach");
    }
