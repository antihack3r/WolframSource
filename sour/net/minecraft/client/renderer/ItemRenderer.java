...
public class ItemRenderer {
    ...
    public void renderItemInFirstPerson(float partialTicks) {
        ...
        EnumHand enumhand = (EnumHand)((Object)MoreObjects.firstNonNull((Object)((Object)abstractclientplayer.swingingHand), (Object)((Object)EnumHand.MAIN_HAND)));
    ...
    public void renderOverlays(float partialTicks) {
        ...
        if (!this.mc.player.isSpectator()) {
            if (this.mc.player.isInsideOfMaterial(Material.WATER) && !Reflector.callBoolean(Reflector.ForgeEventFactory_renderWaterOverlay, this.mc.player, Float.valueOf(partialTicks))) {
                this.renderWaterOverlayTexture(partialTicks);
            }
            if (this.mc.player.isBurning() && !Reflector.callBoolean(Reflector.ForgeEventFactory_renderFireOverlay, this.mc.player, Float.valueOf(partialTicks))) {
