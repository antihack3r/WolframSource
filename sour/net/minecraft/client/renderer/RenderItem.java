...
implements IResourceManagerReloadListener {
    ...
    public RenderItem(TextureManager p_i46552_1_, ModelManager p_i46552_2_, ItemColors p_i46552_3_) {
        ...
        this.itemModelMesher = Reflector.ItemModelMesherForge_Constructor.exists() ? (ItemModelMesher)Reflector.newInstance(Reflector.ItemModelMesherForge_Constructor, p_i46552_2_) : new ItemModelMesher(p_i46552_2_);
        this.registerItems();
    ...
    public IBakedModel getItemModelWithOverrides(ItemStack stack, @Nullable World worldIn, @Nullable EntityLivingBase entitylivingbaseIn) {
        ...
        if (Config.isCustomItems()) {
            ...
            if ((ibakedmodel1 = CustomItems.getCustomItemModel(stack, ibakedmodel, this.modelLocation, true)) != ibakedmodel) {
                return ibakedmodel1;
            }
        }
    ...
    protected void func_191962_a(ItemStack p_191962_1_, int p_191962_2_, int p_191962_3_, IBakedModel p_191962_4_) {
        ...
        if (Reflector.ForgeHooksClient_handleCameraTransforms.exists()) {
            p_191962_4_ = (IBakedModel)Reflector.call(Reflector.ForgeHooksClient_handleCameraTransforms, new Object[]{p_191962_4_, ItemCameraTransforms.TransformType.GUI, false});
        } else {
