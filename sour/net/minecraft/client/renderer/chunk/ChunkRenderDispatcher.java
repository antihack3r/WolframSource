...
public class ChunkRenderDispatcher {
    ...
    public ChunkRenderDispatcher(int p_i1_1_) {
        ...
        this.countRenderBuilders = p_i1_1_ < 0 ? MathHelper.clamp(j, 1, i) : p_i1_1_;
        if (j > 1) {
            int k = 0;
            while (k < j) {
        ...
        int l = 0;
        while (l < this.countRenderBuilders) {
    ...
    public ListenableFuture<Object> uploadChunk(final BlockRenderLayer p_188245_1_, final BufferBuilder p_188245_2_, final RenderChunk p_188245_3_, final CompiledChunk p_188245_4_, final double p_188245_5_) {
        ...
        Queue<PendingUpload> queue = this.queueChunkUploads;
        synchronized (queue) {
            this.queueChunkUploads.add(new PendingUpload((ListenableFutureTask<Object>)listenablefuturetask, p_188245_5_));
