...
implements IEntityRenderer {
    ...
    protected void renderLivingLabel(T entityIn, String str, double x, double y, double z, int maxDistance) {
        NametagRenderEvent event = new NametagRenderEvent((Entity)entityIn, str);
        ...
        if (d0 <= (double)(maxDistance * maxDistance)) {
            boolean flag = ((Entity)entityIn).isSneaking() && !Wolfram.getWolfram().moduleManager.getModule("nametags").isEnabled();
