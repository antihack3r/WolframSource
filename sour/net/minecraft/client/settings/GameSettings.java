...
public class GameSettings {
    ...
    public static String getKeyDisplayString(int key) {
        ...
        return key < 256 ? Keyboard.getKeyName((int)key) : String.format("%c", Character.valueOf((char)(key - 256))).toUpperCase();
    }
    ...
    public String getKeyBinding(Options settingOption) {
        ...
        if (settingOption.getEnumFloat()) {
            ...
            if (settingOption == Options.SENSITIVITY) {
                if (f == 0.0f) {
                    return String.valueOf(s1) + I18n.format("options.sensitivity.min", new Object[0]);
                }
                return f == 1.0f ? String.valueOf(s1) + I18n.format("options.sensitivity.max", new Object[0]) : String.valueOf(s1) + (int)(f * 200.0f) + "%";
            }
            if (settingOption == Options.FOV) {
                if (f1 == 70.0f) {
                    return String.valueOf(s1) + I18n.format("options.fov.min", new Object[0]);
                }
                return f1 == 110.0f ? String.valueOf(s1) + I18n.format("options.fov.max", new Object[0]) : String.valueOf(s1) + (int)f1;
            }
            if (settingOption == Options.FRAMERATE_LIMIT) {
                return f1 == settingOption.valueMax ? String.valueOf(s1) + I18n.format("options.framerateLimit.max", new Object[0]) : String.valueOf(s1) + I18n.format("options.framerate", (int)f1);
            }
            if (settingOption == Options.RENDER_CLOUDS) {
                return f1 == settingOption.valueMin ? String.valueOf(s1) + I18n.format("options.cloudHeight.min", new Object[0]) : String.valueOf(s1) + ((int)f1 + 128);
            }
            if (settingOption == Options.GAMMA) {
                if (f == 0.0f) {
                    return String.valueOf(s1) + I18n.format("options.gamma.min", new Object[0]);
                }
                return f == 1.0f ? String.valueOf(s1) + I18n.format("options.gamma.max", new Object[0]) : String.valueOf(s1) + "+" + (int)(f * 100.0f) + "%";
            }
            if (settingOption == Options.SATURATION) {
                return String.valueOf(s1) + (int)(f * 400.0f) + "%";
            }
            if (settingOption == Options.CHAT_OPACITY) {
                return String.valueOf(s1) + (int)(f * 90.0f + 10.0f) + "%";
            }
            if (settingOption == Options.CHAT_HEIGHT_UNFOCUSED) {
                return String.valueOf(s1) + WolframNewChat.calculateChatboxHeight(f) + "px";
            }
            if (settingOption == Options.CHAT_HEIGHT_FOCUSED) {
                return String.valueOf(s1) + WolframNewChat.calculateChatboxHeight(f) + "px";
            }
            if (settingOption == Options.CHAT_WIDTH) {
                return String.valueOf(s1) + WolframNewChat.calculateChatboxWidth(f) + "px";
            }
            if (settingOption == Options.RENDER_DISTANCE) {
                return String.valueOf(s1) + I18n.format("options.chunks", (int)f1);
            }
            if (settingOption == Options.MIPMAP_LEVELS) {
                return f1 == 0.0f ? String.valueOf(s1) + I18n.format("options.off", new Object[0]) : String.valueOf(s1) + (int)f1;
            }
            return f == 0.0f ? String.valueOf(s1) + I18n.format("options.off", new Object[0]) : String.valueOf(s1) + (int)(f * 100.0f) + "%";
        }
        ...
        if (settingOption == Options.MAIN_HAND) {
            return String.valueOf(s1) + (Object)((Object)this.mainHand);
        }
        ...
        if (settingOption == Options.ATTACK_INDICATOR) {
            return String.valueOf(s1) + GameSettings.getTranslation(ATTACK_INDICATORS, this.attackIndicator);
        }
        if (settingOption == Options.NARRATOR) {
            return NarratorChatListener.field_193643_a.func_193640_a() ? String.valueOf(s1) + GameSettings.getTranslation(field_193632_b, this.field_192571_R) : String.valueOf(s1) + I18n.format("options.narrator.notavailable", new Object[0]);
        }
        return s1;
    }
    ...
    public void loadOptions() {
        try {
            ...
            List list = IOUtils.readLines((InputStream)new FileInputStream(this.optionsFile), (Charset)StandardCharsets.UTF_8);
            ...
            for (String s1 : nbttagcompound.getKeySet()) {
                ...
                try {
                    ...
                    int n2 = 0;
                    while (n2 < n) {
                        KeyBinding keybinding = objectArray[n2];
                    ...
                    n2 = 0;
                    while (n2 < n) {
                        KeyBinding soundcategory = objectArray[n2];
                        if (s1.equals("soundCategory_" + ((SoundCategory)((Object)soundcategory)).getName())) {
                            this.soundLevels.put((SoundCategory)((Object)soundcategory), Float.valueOf(this.parseFloat(s2)));
                        }
                        ++n2;
                    }
                    ...
                    n2 = 0;
                    while (n2 < n) {
                        KeyBinding enumplayermodelparts = objectArray[n2];
                        if (s1.equals("modelPart_" + ((EnumPlayerModelParts)((Object)enumplayermodelparts)).getPartName())) {
                            this.setModelPartEnabled((EnumPlayerModelParts)((Object)enumplayermodelparts), "true".equals(s2));
                        }
                        ++n2;
                    }
                }
    ...
    public void saveOptions() {
        block16: {
            Object object;
            Wolfram.getWolfram().storageManager.saveAll();
                ...
                try {
                    ...
                    while (n2 < n) {
                        ...
                        if (Reflector.ForgeKeyBinding_getKeyModifier.exists()) {
                            ...
                            printwriter.println(object1 != (object2 = Reflector.getFieldValue(Reflector.KeyModifier_NONE)) ? String.valueOf(s) + ":" + object1 : s);
                        } else {
                    ...
                    while (n2 < n) {
                        KeyBinding soundcategory = objectArray[n2];
                        printwriter.println("soundCategory_" + ((SoundCategory)((Object)soundcategory)).getName() + ":" + this.getSoundLevel((SoundCategory)((Object)soundcategory)));
                        ++n2;
                    }
                    objectArray = EnumPlayerModelParts.values();
                    n = objectArray.length;
    ...
    private String getKeyBindingOF(Options p_getKeyBindingOF_1_) {
        ...
        if (p_getKeyBindingOF_1_ == Options.AA_LEVEL) {
            ...
            return this.ofAaLevel == 0 ? String.valueOf(s) + Lang.getOff() + s3 : String.valueOf(s) + this.ofAaLevel + s3;
        }
        ...
        if (p_getKeyBindingOF_1_ == Options.DYNAMIC_LIGHTS) {
            ...
            return String.valueOf(s) + GameSettings.getTranslation(KEYS_DYNAMIC_LIGHTS, k);
        }
        ...
        if (p_getKeyBindingOF_1_ == Options.FULLSCREEN_MODE) {
            return this.ofFullscreenMode.equals(DEFAULT_STR) ? String.valueOf(s) + Lang.getDefault() : String.valueOf(s) + this.ofFullscreenMode;
        }
