...
public class RecipeItemHelper {
    ...
    public void func_194112_a(ItemStack p_194112_1_) {
        if (!(p_194112_1_.func_190926_b() || p_194112_1_.isItemDamaged() || p_194112_1_.isItemEnchanted() || p_194112_1_.hasDisplayName())) {
            int i = RecipeItemHelper.func_194113_b(p_194112_1_);
    ...
    public static ItemStack func_194115_b(int p_194115_0_) {
        return p_194115_0_ == 0 ? ItemStack.EMPTY : new ItemStack(Item.getItemById(p_194115_0_ >> 16 & 0xFFFF), 1, p_194115_0_ & 0xFFFF);
    }
    ...
    class RecipePicker {
        ...
        public RecipePicker(IRecipe p_i47608_2_) {
            ...
            int i = 0;
            while (i < this.field_194106_c.size()) {
                IntList intlist = this.field_194106_c.get(i).func_194139_b();
                int j = 0;
                while (j < this.field_194109_f) {
        ...
        public boolean func_194092_a(int p_194092_1_, @Nullable IntList p_194092_2_) {
            ...
            while (this.func_194098_a(p_194092_1_)) {
                ...
                int i1 = 0;
                while (i1 < l) {
                    this.func_194089_c((i1 & 1) == 0, (Integer)this.field_194111_h.get(i1), (Integer)this.field_194111_h.get(i1 + 1));
                    ++i1;
                }
            ...
            boolean bl = flag1 = flag && p_194092_2_ != null;
            if (flag1) {
                p_194092_2_.clear();
            }
            ...
            while (l < k) {
                if (RecipeItemHelper.this.field_194124_a.get(this.field_194108_e[l]) >= p_194098_1_) {
                    ...
                    while (!this.field_194111_h.isEmpty()) {
                        ...
                        if (!flag && !this.func_194091_b(j1)) break;
        ...
        public int func_194102_b(int p_194102_1_, @Nullable IntList p_194102_2_) {
            ...
            while (true) {
                int i1;
                if (this.func_194092_a(i1 = (k + l) / 2, null)) {
                    if (l - k <= 1) {
                        if (i1 > 0) {
