...
extends Entity {
    ...
    public void onEntityUpdate() {
        ...
        if (this.isEntityAlive()) {
            ...
            if (!this.world.isRemote && !Objects.equal((Object)this.prevBlockpos, (Object)(blockpos = new BlockPos(this)))) {
    ...
    public void writeEntityToNBT(NBTTagCompound compound) {
        ...
        entityEquipmentSlotArray = EntityEquipmentSlot.values();
        n = entityEquipmentSlotArray.length;
        n2 = 0;
        while (n2 < n) {
            EntityEquipmentSlot entityequipmentslot1 = entityEquipmentSlotArray[n2];
    ...
    private boolean canBlockDamageSource(DamageSource damageSourceIn) {
        Vec3d vec3d;
        if (!damageSourceIn.isUnblockable() && this.isActiveItemStackBlocking() && (vec3d = damageSourceIn.getDamageLocation()) != null) {
    ...
    public void renderBrokenItemStack(ItemStack stack) {
        ...
        while (i < 5) {
            ...
            this.world.spawnParticle(EnumParticleTypes.ITEM_CRACK, vec3d1.xCoord, vec3d1.yCoord, vec3d1.zCoord, vec3d.xCoord, vec3d.yCoord + 0.05, vec3d.zCoord, Item.getIdFromItem(stack.getItem()));
            ++i;
        }
    }
    ...
    public void dismountEntity(Entity entityIn) {
        if (!(entityIn instanceof EntityBoat) && !(entityIn instanceof AbstractHorse)) {
            ...
            if (enumfacing1 != null) {
                ...
                int[][] nArrayArray2 = aint1;
                int n = aint1.length;
                int n2 = 0;
                while (n2 < n) {
                    int[] aint = nArrayArray2[n2];
                    ...
                    } else if (!this.world.collidesWithAnyBlock(axisalignedbb1.offset(0.0, 1.0, 0.0)) && this.world.getBlockState(new BlockPos(d11, this.posY + 1.0, d12)).isFullyOpaque()) {
                        d1 = d11;
                        d13 = this.posY + 2.0;
                        d14 = d12;
                    }
    ...
    protected void jump() {
        ...
        if (Wolfram.getWolfram().moduleManager.getModule("HighJump").isEnabled() && this == Minecraft.getMinecraft().player) {
            this.motionY = 0.75;
        }
    ...
    public void onUpdate() {
        block29: {
            ...
            if (this.world.isRemote) break block29;
            ...
            while (n2 < n) {
                block30: {
                    ...
                    if (!ItemStack.areItemStacksEqual(itemstack1, itemstack)) {
                        ...
                        switch (entityequipmentslot.getSlotType()) {
                            case HAND: {
                                this.handInventory.set(entityequipmentslot.getIndex(), itemstack1.func_190926_b() ? ItemStack.EMPTY : itemstack1.copy());
                                break;
                            }
                            case ARMOR: {
                                this.armorArray.set(entityequipmentslot.getIndex(), itemstack1.func_190926_b() ? ItemStack.EMPTY : itemstack1.copy());
                            }
                        }
                    }
                }
    ...
    public void onLivingUpdate() {
        ...
        if (this.isJumping) {
            if (this.isInWater()) {
                ...
                this.handleJumpLava();
            } else if (this.onGround && this.jumpTicks == 0 && (!Wolfram.getWolfram().moduleManager.isEnabled("airmove") || ((AirMove)Wolfram.getWolfram().moduleManager.getModule("airmove")).isOnGround())) {
                this.jump();
                this.jumpTicks = 10;
            }
        } else {
            ...
            if (stack.getItemUseAction() == EnumAction.EAT) {
                ...
                while (i < eatingParticleCount) {
                    ...
                    if (stack.getHasSubtypes()) {
                        this.world.spawnParticle(EnumParticleTypes.ITEM_CRACK, vec3d1.xCoord, vec3d1.yCoord, vec3d1.zCoord, vec3d.xCoord, vec3d.yCoord + 0.05, vec3d.zCoord, Item.getIdFromItem(stack.getItem()), stack.getMetadata());
                    } else {
                        this.world.spawnParticle(EnumParticleTypes.ITEM_CRACK, vec3d1.xCoord, vec3d1.yCoord, vec3d1.zCoord, vec3d.xCoord, vec3d.yCoord + 0.05, vec3d.zCoord, Item.getIdFromItem(stack.getItem()));
                    }
                    ++i;
