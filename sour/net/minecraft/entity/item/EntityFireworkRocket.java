        ...
        if (this.func_191511_j()) {
            ...
            if (this.field_191513_e != null) {
                if (this.field_191513_e.isElytraFlying()) {
                    ...
                    double d0 = 1.5;
                    double d1 = 0.1;
                    this.field_191513_e.motionX += vec3d.xCoord * 0.1 + (vec3d.xCoord * 1.5 - this.field_191513_e.motionX) * 0.5;
                    this.field_191513_e.motionY += vec3d.yCoord * 0.1 + (vec3d.yCoord * 1.5 - this.field_191513_e.motionY) * 0.5;
                    this.field_191513_e.motionZ += vec3d.zCoord * 0.1 + (vec3d.zCoord * 1.5 - this.field_191513_e.motionZ) * 0.5;
                }
