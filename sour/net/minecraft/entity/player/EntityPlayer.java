...
extends EntityLivingBase {
    ...
    public static final DataParameter<Byte> PLAYER_MODEL_FLAG = EntityDataManager.createKey(EntityPlayer.class, DataSerializers.BYTE);
    ...
    public void onUpdate() {
        boolean bl = this.noClip = this.isSpectator() || Wolfram.getWolfram().moduleManager.getModule("freecam").isEnabled();
        if (this.isSpectator()) {
            this.onGround = false;
        }
    ...
    private void func_192028_j(@Nullable NBTTagCompound p_192028_1_) {
        String s;
        if ((p_192028_1_ != null && !p_192028_1_.hasKey("Silent") || !p_192028_1_.getBoolean("Silent")) && (s = p_192028_1_.getString("id")).equals(EntityList.func_191306_a(EntityParrot.class).toString())) {
    ...
    public EnumActionResult func_190775_a(Entity p_190775_1_, EnumHand p_190775_2_) {
        ...
        ItemStack itemStack = itemstack1 = itemstack.func_190926_b() ? ItemStack.EMPTY : itemstack.copy();
    ...
    public boolean replaceItemInInventory(int inventorySlot, ItemStack itemStackIn) {
        ...
        if (!itemStackIn.func_190926_b() && (!(itemStackIn.getItem() instanceof ItemArmor) && !(itemStackIn.getItem() instanceof ItemElytra) ? entityequipmentslot != EntityEquipmentSlot.HEAD : EntityLiving.getSlotForItemStack(itemStackIn) != entityequipmentslot)) {
            return false;
        }
