...
implements IProjectile {
    ...
    protected Entity findEntityOnPath(Vec3d start, Vec3d end) {
        ...
        while (i < list.size()) {
            ...
            if (!(entity1 == this.shootingEntity && this.ticksInAir < 5 || (raytraceresult = (axisalignedbb = entity1.getEntityBoundingBox().expandXyz(0.3f)).calculateIntercept(start, end)) == null || !((d1 = start.squareDistanceTo(raytraceresult.hitVec)) < d0) && d0 != 0.0)) {
                entity = entity1;
                d0 = d1;
            }
            ++i;
