    ...
    public ItemStack transferStackInSlot(EntityPlayer playerIn, int index) {
        ...
        if (slot != null && slot.getHasStack()) {
            ...
            if ((index < 0 || index > 2) && index != 3 && index != 4) {
                if (this.theSlot.isItemValid(itemstack1) ? !this.mergeItemStack(itemstack1, 3, 4, false) : (Potion.canHoldPotion(itemstack) && itemstack.func_190916_E() == 1 ? !this.mergeItemStack(itemstack1, 0, 3, false) : (Fuel.isValidBrewingFuel(itemstack) ? !this.mergeItemStack(itemstack1, 4, 5, false) : (index >= 5 && index < 32 ? !this.mergeItemStack(itemstack1, 32, 41, false) : (index >= 32 && index < 41 ? !this.mergeItemStack(itemstack1, 5, 32, false) : !this.mergeItemStack(itemstack1, 5, 41, false)))))) {
