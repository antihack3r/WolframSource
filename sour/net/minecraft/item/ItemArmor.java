...
extends Item {
    ...
    public static ItemStack dispenseArmor(IBlockSource blockSource, ItemStack stack) {
        ...
        List<EntityLivingBase> list = blockSource.getWorld().getEntitiesWithinAABB(EntityLivingBase.class, new AxisAlignedBB(blockpos), Predicates.and(EntitySelectors.NOT_SPECTATING, (Predicate)new EntitySelectors.ArmoredMob(stack)));
        if (list.isEmpty()) {
    ...
    public Multimap<String, AttributeModifier> getItemAttributeModifiers(EntityEquipmentSlot equipmentSlot) {
        ...
        if (equipmentSlot == this.armorType) {
            multimap.put((Object)SharedMonsterAttributes.ARMOR.getAttributeUnlocalizedName(), (Object)new AttributeModifier(ARMOR_MODIFIERS[equipmentSlot.getIndex()], "Armor modifier", this.damageReduceAmount, 0));
            multimap.put((Object)SharedMonsterAttributes.ARMOR_TOUGHNESS.getAttributeUnlocalizedName(), (Object)new AttributeModifier(ARMOR_MODIFIERS[equipmentSlot.getIndex()], "Armor toughness", this.toughness, 0));
        }
        return multimap;
    }
