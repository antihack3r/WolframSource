...
public class CraftingManager {
    ...
    private static boolean func_192420_c() {
         ...
         * 
         * org.benf.cfr.reader.util.ConfusedCFRException: Tried to end blocks [1[TRYBLOCK], 4[TRYBLOCK], 10[CATCHBLOCK], 11[CATCHBLOCK], 2[TRYBLOCK]], but top level block is 6[TRYBLOCK]
    ...
    public static NonNullList<ItemStack> getRemainingItems(InventoryCrafting p_180303_0_, World craftMatrix) {
        ...
        NonNullList<ItemStack> nonnulllist = NonNullList.func_191197_a(p_180303_0_.getSizeInventory(), ItemStack.EMPTY);
        int i = 0;
