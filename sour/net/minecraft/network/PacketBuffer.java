...
extends ByteBuf {
    ...
    public ITextComponent readTextComponent() throws IOException {
        return ITextComponent.Serializer.jsonToComponent(this.readStringFromBuffer(Short.MAX_VALUE));
    }
    ...
    public ItemStack readItemStackFromBuffer() throws IOException {
        ...
        ItemStack itemstack = new ItemStack(Item.getItemById(i), (int)j, (int)k);
    ...
    public ResourceLocation func_192575_l() {
        return new ResourceLocation(this.readStringFromBuffer(Short.MAX_VALUE));
    }
