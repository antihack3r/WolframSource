...
public abstract class PathNavigate {
    ...
    public Path getPathToPos(BlockPos pos) {
        ...
        Path path = this.pathFinder.findPath((IBlockAccess)chunkcache, (Entity)this.theEntity, this.targetPos, f);
    ...
    public Path getPathToEntityLiving(Entity entityIn) {
        ...
        Path path = this.pathFinder.findPath((IBlockAccess)chunkcache, (Entity)this.theEntity, entityIn, f);
        this.worldObj.theProfiler.endSection();
        return path;
    }
