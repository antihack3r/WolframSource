...
implements Comparable<PotionEffect> {
    ...
    public String toString() {
        String s = this.amplifier > 0 ? String.valueOf(this.getEffectName()) + " x " + (this.amplifier + 1) + ", Duration: " + this.duration : String.valueOf(this.getEffectName()) + ", Duration: " + this.duration;
