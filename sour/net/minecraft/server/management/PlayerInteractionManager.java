...
public class PlayerInteractionManager {
    ...
    public boolean tryHarvestBlock(BlockPos pos) {
        ...
        if (this.isCreative()) {
            ...
            ItemStack itemstack2 = itemstack1.func_190926_b() ? ItemStack.EMPTY : itemstack1.copy();
    ...
    public EnumActionResult processRightClickBlock(EntityPlayer player, World worldIn, ItemStack stack, EnumHand hand, BlockPos pos, EnumFacing facing, float hitX, float hitY, float hitZ) {
        ...
        if ((!player.isSneaking() || player.getHeldItemMainhand().func_190926_b() && player.getHeldItemOffhand().func_190926_b()) && (iblockstate = worldIn.getBlockState(pos)).getBlock().onBlockActivated(worldIn, pos, iblockstate, player, hand, facing, hitX, hitY, hitZ)) {
            return EnumActionResult.SUCCESS;
        }
