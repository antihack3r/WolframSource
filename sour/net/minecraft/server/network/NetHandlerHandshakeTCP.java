        ...
        switch (packetIn.getRequestedState()) {
            case LOGIN: {
                ...
                if (packetIn.getProtocolVersion() > 335) {
                    TextComponentTranslation itextcomponent = new TextComponentTranslation("multiplayer.disconnect.outdated_server", "1.12");
                    this.networkManager.sendPacket(new SPacketDisconnect(itextcomponent));
                    this.networkManager.closeChannel(itextcomponent);
                    break;
                }
                if (packetIn.getProtocolVersion() < 335) {
                    TextComponentTranslation itextcomponent1 = new TextComponentTranslation("multiplayer.disconnect.outdated_client", "1.12");
