...
public class CrashReporter {
    public static void onCrashReport(CrashReport p_onCrashReport_0_, CrashReportCategory p_onCrashReport_1_) {
        try {
            ...
            CrashReporter.extendCrashReport(p_onCrashReport_1_);
    ...
    private static String makeSummary(CrashReport p_makeSummary_0_) {
        ...
        String s1 = String.valueOf(throwable.getClass().getName()) + ": " + throwable.getMessage() + " (" + p_makeSummary_0_.getDescription() + ") [" + s + "]";
        return s1;
    }
