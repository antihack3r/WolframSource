...
public class Mipmaps {
    ...
    public Mipmaps(String p_i63_1_, int p_i63_2_, int p_i63_3_, int[] p_i63_4_, boolean p_i63_5_) {
        ...
        this.mipmapDimensions = Mipmaps.makeMipmapDimensions(p_i63_2_, p_i63_3_, p_i63_1_);
        this.mipmapDatas = Mipmaps.generateMipMapData(p_i63_4_, p_i63_2_, p_i63_3_, this.mipmapDimensions);
        if (p_i63_5_) {
    ...
    public static void allocateMipmapTextures(int p_allocateMipmapTextures_0_, int p_allocateMipmapTextures_1_, String p_allocateMipmapTextures_2_) {
        ...
        while (i < adimension.length) {
            ...
            int l = i + 1;
            GL11.glTexImage2D((int)3553, (int)l, (int)6408, (int)j, (int)k, (int)0, (int)32993, (int)33639, null);
            ++i;
        }
    }
}
