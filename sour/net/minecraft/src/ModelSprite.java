...
public class ModelSprite {
    ...
    public void render(Tessellator p_render_1_, float p_render_2_) {
        ...
        ModelSprite.renderItemIn2D(p_render_1_, f, f2, f1, f3, this.sizeX, this.sizeY, p_render_2_ * (float)this.sizeZ, this.modelRenderer.textureWidth, this.modelRenderer.textureHeight);
        GlStateManager.translate(-this.posX * p_render_2_, -this.posY * p_render_2_, -this.posZ * p_render_2_);
    }
    ...
    public static void renderItemIn2D(Tessellator p_renderItemIn2D_0_, float p_renderItemIn2D_1_, float p_renderItemIn2D_2_, float p_renderItemIn2D_3_, float p_renderItemIn2D_4_, int p_renderItemIn2D_5_, int p_renderItemIn2D_6_, float p_renderItemIn2D_7_, float p_renderItemIn2D_8_, float p_renderItemIn2D_9_) {
        ...
        bufferbuilder.pos(0.0, d1, 0.0).tex(p_renderItemIn2D_1_, p_renderItemIn2D_4_).endVertex();
        bufferbuilder.pos(d0, d1, 0.0).tex(p_renderItemIn2D_3_, p_renderItemIn2D_4_).endVertex();
        bufferbuilder.pos(d0, 0.0, 0.0).tex(p_renderItemIn2D_3_, p_renderItemIn2D_2_).endVertex();
        bufferbuilder.pos(0.0, 0.0, 0.0).tex(p_renderItemIn2D_1_, p_renderItemIn2D_2_).endVertex();
        p_renderItemIn2D_0_.draw();
        GL11.glNormal3f((float)0.0f, (float)0.0f, (float)1.0f);
        bufferbuilder.begin(7, DefaultVertexFormats.POSITION_TEX);
        bufferbuilder.pos(0.0, 0.0, p_renderItemIn2D_7_).tex(p_renderItemIn2D_1_, p_renderItemIn2D_2_).endVertex();
        bufferbuilder.pos(d0, 0.0, p_renderItemIn2D_7_).tex(p_renderItemIn2D_3_, p_renderItemIn2D_2_).endVertex();
        bufferbuilder.pos(d0, d1, p_renderItemIn2D_7_).tex(p_renderItemIn2D_3_, p_renderItemIn2D_4_).endVertex();
        bufferbuilder.pos(0.0, d1, p_renderItemIn2D_7_).tex(p_renderItemIn2D_1_, p_renderItemIn2D_4_).endVertex();
        p_renderItemIn2D_0_.draw();
        ...
        while (i < p_renderItemIn2D_5_) {
            ...
            bufferbuilder.pos((double)f4 * d0, d1, 0.0).tex(f5, p_renderItemIn2D_4_).endVertex();
            bufferbuilder.pos((double)f4 * d0, 0.0, 0.0).tex(f5, p_renderItemIn2D_2_).endVertex();
            bufferbuilder.pos((double)f4 * d0, 0.0, p_renderItemIn2D_7_).tex(f5, p_renderItemIn2D_2_).endVertex();
            ++i;
        }
        p_renderItemIn2D_0_.draw();
        GL11.glNormal3f((float)1.0f, (float)0.0f, (float)0.0f);
        ...
        while (j < p_renderItemIn2D_5_) {
            ...
            bufferbuilder.pos((double)f6 * d0, 0.0, p_renderItemIn2D_7_).tex(f10, p_renderItemIn2D_2_).endVertex();
            bufferbuilder.pos((double)f6 * d0, 0.0, 0.0).tex(f10, p_renderItemIn2D_2_).endVertex();
            bufferbuilder.pos((double)f6 * d0, d1, 0.0).tex(f10, p_renderItemIn2D_4_).endVertex();
        ...
        while (k < p_renderItemIn2D_6_) {
            ...
            bufferbuilder.pos(0.0, (double)f13 * d1, p_renderItemIn2D_7_).tex(p_renderItemIn2D_1_, f11).endVertex();
            bufferbuilder.pos(d0, (double)f13 * d1, p_renderItemIn2D_7_).tex(p_renderItemIn2D_3_, f11).endVertex();
            bufferbuilder.pos(d0, (double)f13 * d1, 0.0).tex(p_renderItemIn2D_3_, f11).endVertex();
            bufferbuilder.pos(0.0, (double)f13 * d1, 0.0).tex(p_renderItemIn2D_1_, f11).endVertex();
            ++k;
        }
        p_renderItemIn2D_0_.draw();
        GL11.glNormal3f((float)0.0f, (float)-1.0f, (float)0.0f);
        ...
        while (l < p_renderItemIn2D_6_) {
            ...
            bufferbuilder.pos(0.0, (double)f9 * d1, p_renderItemIn2D_7_).tex(p_renderItemIn2D_1_, f12).endVertex();
            bufferbuilder.pos(0.0, (double)f9 * d1, 0.0).tex(p_renderItemIn2D_1_, f12).endVertex();
            bufferbuilder.pos(d0, (double)f9 * d1, 0.0).tex(p_renderItemIn2D_3_, f12).endVertex();
            ++l;
        }
        p_renderItemIn2D_0_.draw();
    }
