...
public class TextureUtils {
    ...
    public static void update() {
        ...
        if (texturemap != null) {
            ...
            iconGrassTop = texturemap.getSpriteSafe(String.valueOf(s) + texGrassTop);
            iconGrassSide = texturemap.getSpriteSafe(String.valueOf(s) + texGrassSide);
            iconGrassSideOverlay = texturemap.getSpriteSafe(String.valueOf(s) + texGrassSideOverlay);
            iconSnow = texturemap.getSpriteSafe(String.valueOf(s) + texSnow);
            iconGrassSideSnowed = texturemap.getSpriteSafe(String.valueOf(s) + texGrassSideSnowed);
            iconMyceliumSide = texturemap.getSpriteSafe(String.valueOf(s) + texMyceliumSide);
            iconMyceliumTop = texturemap.getSpriteSafe(String.valueOf(s) + texMyceliumTop);
            iconWaterStill = texturemap.getSpriteSafe(String.valueOf(s) + texWaterStill);
            iconWaterFlow = texturemap.getSpriteSafe(String.valueOf(s) + texWaterFlow);
            iconLavaStill = texturemap.getSpriteSafe(String.valueOf(s) + texLavaStill);
            iconLavaFlow = texturemap.getSpriteSafe(String.valueOf(s) + texLavaFlow);
            iconFireLayer0 = texturemap.getSpriteSafe(String.valueOf(s) + texFireLayer0);
            iconFireLayer1 = texturemap.getSpriteSafe(String.valueOf(s) + texFireLayer1);
            iconPortal = texturemap.getSpriteSafe(String.valueOf(s) + texPortal);
            iconGlass = texturemap.getSpriteSafe(String.valueOf(s) + texGlass);
            iconGlassPaneTop = texturemap.getSpriteSafe(String.valueOf(s) + texGlassPaneTop);
    ...
    public static String fixResourcePath(String p_fixResourcePath_0_, String p_fixResourcePath_1_) {
        ...
        if (p_fixResourcePath_0_.startsWith("~/")) {
            p_fixResourcePath_0_ = p_fixResourcePath_0_.substring(2);
            p_fixResourcePath_0_ = String.valueOf(s1) + p_fixResourcePath_0_;
            return p_fixResourcePath_0_;
        }
        if (p_fixResourcePath_0_.startsWith("/")) {
            p_fixResourcePath_0_ = String.valueOf(s1) + p_fixResourcePath_0_.substring(1);
            return p_fixResourcePath_0_;
        }
        return p_fixResourcePath_0_;
    }
    ...
    public static int scaleMinTo(int p_scaleMinTo_0_, int p_scaleMinTo_1_) {
        ...
        int i = p_scaleMinTo_0_;
        while (i < p_scaleMinTo_1_) {
            i *= 2;
        }
        return i;
    }
    ...
    public static void saveGlTexture(String p_saveGlTexture_0_, int p_saveGlTexture_1_, int p_saveGlTexture_2_, int p_saveGlTexture_3_, int p_saveGlTexture_4_) {
        ...
        int i = 0;
        while (i < 16) {
            File file3 = new File(String.valueOf(p_saveGlTexture_0_) + "_" + i + ".png");
            file3.delete();
            ++i;
        }
        int i1 = 0;
        while (i1 <= p_saveGlTexture_2_) {
            File file4 = new File(String.valueOf(p_saveGlTexture_0_) + "_" + i1 + ".png");
