...
public class RecipeBook {
    ...
    public void func_194073_a(IRecipe p_194073_1_) {
        if (!p_194073_1_.func_192399_d()) {
            this.field_194077_a.set(RecipeBook.func_194075_d(p_194073_1_));
        }
    }

    public boolean func_193830_f(IRecipe p_193830_1_) {
        return this.field_194077_a.get(RecipeBook.func_194075_d(p_193830_1_));
    }

    public void func_193831_b(IRecipe p_193831_1_) {
        int i = RecipeBook.func_194075_d(p_193831_1_);
    ...
    public boolean func_194076_e(IRecipe p_194076_1_) {
        return this.field_194078_b.get(RecipeBook.func_194075_d(p_194076_1_));
    }

    public void func_194074_f(IRecipe p_194074_1_) {
        this.field_194078_b.clear(RecipeBook.func_194075_d(p_194074_1_));
    }

    public void func_193825_e(IRecipe p_193825_1_) {
        this.field_194078_b.set(RecipeBook.func_194075_d(p_193825_1_));
    }
