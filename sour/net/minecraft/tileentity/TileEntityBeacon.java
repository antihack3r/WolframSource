...
ISidedInventory {
    ...
    static {
        Potion[][] potionArray = EFFECTS_LIST;
        int n = EFFECTS_LIST.length;
        int n2 = 0;
        while (n2 < n) {
            Potion[] apotion = potionArray[n2];
    ...
    private void updateSegmentColors() {
        ...
        tileentitybeacon$beamsegment = new BeamSegment(EnumDyeColor.WHITE.func_193349_f());
        ...
        while (i1 < 256) {
            block15: {
                iblockstate = this.world.getBlockState(blockpos$mutableblockpos.setPos(i, i1, k));
                if (iblockstate.getBlock() != Blocks.STAINED_GLASS) break block15;
