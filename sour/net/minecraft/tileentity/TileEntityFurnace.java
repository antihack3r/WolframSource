...
ISidedInventory {
    ...
    public void readFromNBT(NBTTagCompound compound) {
        ...
        this.furnaceItemStacks = NonNullList.func_191197_a(this.getSizeInventory(), ItemStack.EMPTY);
    ...
    private boolean canSmelt() {
        ...
        if (itemstack1.func_190916_E() < this.getInventoryStackLimit() && itemstack1.func_190916_E() < itemstack1.getMaxStackSize()) {
            return true;
        }
