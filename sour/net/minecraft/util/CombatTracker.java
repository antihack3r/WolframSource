        ...
        if (combatentry != null && combatentry1.getDamageSrc() == DamageSource.fall) {
            ...
            if (combatentry.getDamageSrc() != DamageSource.fall && combatentry.getDamageSrc() != DamageSource.outOfWorld) {
                if (!(itextcomponent2 == null || itextcomponent1 != null && itextcomponent2.equals(itextcomponent1))) {
                    ...
                    ItemStack itemStack = itemstack1 = entity1 instanceof EntityLivingBase ? ((EntityLivingBase)entity1).getHeldItemMainhand() : ItemStack.EMPTY;
                    itextcomponent = !itemstack1.func_190926_b() && itemstack1.hasDisplayName() ? new TextComponentTranslation("death.fell.assist.item", this.fighter.getDisplayName(), itextcomponent2, itemstack1.getTextComponent()) : new TextComponentTranslation("death.fell.assist", this.fighter.getDisplayName(), itextcomponent2);
                } else if (itextcomponent1 != null) {
                    ItemStack itemstack;
                    ItemStack itemStack = itemstack = entity instanceof EntityLivingBase ? ((EntityLivingBase)entity).getHeldItemMainhand() : ItemStack.EMPTY;
                    itextcomponent = !itemstack.func_190926_b() && itemstack.hasDisplayName() ? new TextComponentTranslation("death.fell.finish.item", this.fighter.getDisplayName(), itextcomponent1, itemstack.getTextComponent()) : new TextComponentTranslation("death.fell.finish", this.fighter.getDisplayName(), itextcomponent1);
                } else {
