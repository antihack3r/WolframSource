        ...
        if (ashaderoption != null) {
            ...
            while (i2 < ashaderoption.length) {
                ...
                if (shaderoption != null && shaderoption.isVisible()) {
                    ...
                    GuiButtonShaderOption guibuttonshaderoption = Shaders.isShaderPackOptionSlider(shaderoption.getName()) ? new GuiSliderShaderOption(i + i2, i3, j3, k3, k1, shaderoption, s) : new GuiButtonShaderOption(i + i2, i3, j3, k3, k1, shaderoption, s);
