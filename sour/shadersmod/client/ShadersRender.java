...
public class ShadersRender {
    ...
    public static boolean renderEndPortal(TileEntityEndPortal te, double x, double y, double z, float partialTicks, int destroyStage, float offset) {
        ...
        if (te.shouldRenderFace(EnumFacing.SOUTH)) {
            bufferbuilder.pos(x, y, z + 1.0).color(f1, f2, f3, 1.0f).tex(f4 + f6, f4 + f6).lightmap(i, i).endVertex();
            bufferbuilder.pos(x + 1.0, y, z + 1.0).color(f1, f2, f3, 1.0f).tex(f4 + f6, f5 + f6).lightmap(i, i).endVertex();
            bufferbuilder.pos(x + 1.0, y + 1.0, z + 1.0).color(f1, f2, f3, 1.0f).tex(f5 + f6, f5 + f6).lightmap(i, i).endVertex();
            bufferbuilder.pos(x, y + 1.0, z + 1.0).color(f1, f2, f3, 1.0f).tex(f5 + f6, f4 + f6).lightmap(i, i).endVertex();
        }
        if (te.shouldRenderFace(EnumFacing.NORTH)) {
            bufferbuilder.pos(x, y + 1.0, z).color(f1, f2, f3, 1.0f).tex(f5 + f6, f5 + f6).lightmap(i, i).endVertex();
            bufferbuilder.pos(x + 1.0, y + 1.0, z).color(f1, f2, f3, 1.0f).tex(f5 + f6, f4 + f6).lightmap(i, i).endVertex();
            bufferbuilder.pos(x + 1.0, y, z).color(f1, f2, f3, 1.0f).tex(f4 + f6, f4 + f6).lightmap(i, i).endVertex();
            bufferbuilder.pos(x, y, z).color(f1, f2, f3, 1.0f).tex(f4 + f6, f5 + f6).lightmap(i, i).endVertex();
        }
        if (te.shouldRenderFace(EnumFacing.EAST)) {
            bufferbuilder.pos(x + 1.0, y + 1.0, z).color(f1, f2, f3, 1.0f).tex(f5 + f6, f5 + f6).lightmap(i, i).endVertex();
            bufferbuilder.pos(x + 1.0, y + 1.0, z + 1.0).color(f1, f2, f3, 1.0f).tex(f5 + f6, f4 + f6).lightmap(i, i).endVertex();
            bufferbuilder.pos(x + 1.0, y, z + 1.0).color(f1, f2, f3, 1.0f).tex(f4 + f6, f4 + f6).lightmap(i, i).endVertex();
            bufferbuilder.pos(x + 1.0, y, z).color(f1, f2, f3, 1.0f).tex(f4 + f6, f5 + f6).lightmap(i, i).endVertex();
        }
        if (te.shouldRenderFace(EnumFacing.WEST)) {
            bufferbuilder.pos(x, y, z).color(f1, f2, f3, 1.0f).tex(f4 + f6, f4 + f6).lightmap(i, i).endVertex();
            bufferbuilder.pos(x, y, z + 1.0).color(f1, f2, f3, 1.0f).tex(f4 + f6, f5 + f6).lightmap(i, i).endVertex();
            bufferbuilder.pos(x, y + 1.0, z + 1.0).color(f1, f2, f3, 1.0f).tex(f5 + f6, f5 + f6).lightmap(i, i).endVertex();
            bufferbuilder.pos(x, y + 1.0, z).color(f1, f2, f3, 1.0f).tex(f5 + f6, f4 + f6).lightmap(i, i).endVertex();
        }
        if (te.shouldRenderFace(EnumFacing.DOWN)) {
            bufferbuilder.pos(x, y, z).color(f1, f2, f3, 1.0f).tex(f4 + f6, f4 + f6).lightmap(i, i).endVertex();
            bufferbuilder.pos(x + 1.0, y, z).color(f1, f2, f3, 1.0f).tex(f4 + f6, f5 + f6).lightmap(i, i).endVertex();
            bufferbuilder.pos(x + 1.0, y, z + 1.0).color(f1, f2, f3, 1.0f).tex(f5 + f6, f5 + f6).lightmap(i, i).endVertex();
            bufferbuilder.pos(x, y, z + 1.0).color(f1, f2, f3, 1.0f).tex(f5 + f6, f4 + f6).lightmap(i, i).endVertex();
        }
        if (te.shouldRenderFace(EnumFacing.UP)) {
            bufferbuilder.pos(x, y + (double)offset, z + 1.0).color(f1, f2, f3, 1.0f).tex(f4 + f6, f4 + f6).lightmap(i, i).endVertex();
            bufferbuilder.pos(x + 1.0, y + (double)offset, z + 1.0).color(f1, f2, f3, 1.0f).tex(f4 + f6, f5 + f6).lightmap(i, i).endVertex();
            bufferbuilder.pos(x + 1.0, y + (double)offset, z).color(f1, f2, f3, 1.0f).tex(f5 + f6, f5 + f6).lightmap(i, i).endVertex();
